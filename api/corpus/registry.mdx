...
```typescript
import { loadCorpusRegistryManifest } from "bun_nltk/corpus";
...
```typescript
import { downloadCorpusRegistry, loadCorpusBundleFromIndex } from "bun_nltk/corpus";
...
```typescript
import { downloadCorpusRegistry } from "bun_nltk/corpus";
